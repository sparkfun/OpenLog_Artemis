...
* **[COMPILE_BINARY.md](./COMPILE_BINARY)** - contains _abbreviated_ instructions on how to compile the OLA firmware binary manually. It's also more of an aide-memoire really... Sorry about that.
