/* 
  ...
  (done) Add support for the INA3221 Shunt and Bus Voltage Monitor
  (done) Add support for the MCP23017 I/O Expander chip
  (done) Add support fot the MAX11615EEE+ ADC
