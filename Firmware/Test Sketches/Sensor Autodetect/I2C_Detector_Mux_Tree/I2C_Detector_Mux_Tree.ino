/*
  This sketch demonstrates how to use pointers to classes
  to create multiple of a class on the fly, based on the
  number of devices detected.

  This sketch will autodetect and begin sensors with the
  same address through multiple ports on a mux.
*/
