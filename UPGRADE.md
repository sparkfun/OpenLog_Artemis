...
* **OpenLog_Artemis-V10-v28.bin** - is the _stable_ version (2.8) for the **V10 SparkFun (Red) OLA**
* **OpenLog_Artemis-X04-v28.bin** - is the _stable_ version (2.8) for the **X04 SparkX (Black) OLA**
...
* **OpenLog_Artemis-V10-v28-NoPowerLossProtection.bin** is a special build of v2.8 which has no power loss protection
